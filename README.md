# 2PLAY
2PLAY adalah aplikasi manajemen playlist musik berbasis Command Line Interface (CLI) yang dikembangkan menggunakan bahasa C++. Program ini dibuat dengan menerapkan struktur data Pohon Telusur Biner (Binary Search Tree / BST) untuk menyimpan data lagu berdasarkan judul lagu sebagai key utama.
